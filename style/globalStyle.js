...
const posth1Style = `text-4xl font-bold mb-4 mt-4 border-b border-graylv2 pb-2.5`;
const posth2Style = `text-3xl font-bold mb-4 mt-4 border-b border-graylv2 pb-2.5`;
const posth3Style = `text-2xl font-bold mb-4 mt-4 pb-2.5`;
const posth4Style = `text-xl font-bold mb-2 mt-2`;
const posth5Style = `text-lg font-bold mb-2 mt-2`;
const posth6Style = `text-base font-bold mb-2 mt-2`;
...
const postauthorImgStyle = `inline w-6 h-6 object-cover object-center mr-2 overflow-hidden`;
...
const bloglistCardAuthorImgStyle = `inline w-6 h-6 object-cover object-center mr-2 overflow-hidden`;
